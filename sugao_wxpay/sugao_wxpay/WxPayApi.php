...
require_once dirname(__DIR__).'/extra/common.php';
use sugao_wxpay\WxPayException;
use sugao_wxpay\WxPayConfig;
use sugao_wxpay\WxpayData\WxPayResults;
use sugao_wxpay\WxpayData\WxPayReport;
...
//    $unifiedOrder->SetNotify_url('http://' . $_SERVER['HTTP_HOST'] . '/weixinpl/app/api/Pay/car_book_wxpay_notify.php');
